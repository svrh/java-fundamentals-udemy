...
public class Main {
    ...
    public static void main(String[] args) {
        // Write the program to allow players to type full words, or phrases, then move to the
        ...
        locations.put(0, new Location(0, "You are at home."));
        ...
        int location = 1;
        System.out.println("You can type commands such as \"Go West\", \"run South\", or just \"East\", or single letter commands (N, W, S, E, Q) ");
        while (true) {
